...
if __name__ == '__main__':
    normal_m3_policy_kwargs = dict(features_extractor_class=NormalCNN7, features_extractor_kwargs=dict(features_dim=64))
    # normal_m3 = Thread(target=train_a2c, args=('ALE/Breakout-v5','./Breakout', normal_m3_policy_kwargs))
    # normal_m3.start()
    # time.sleep(5)
    train_a2c('ALE/Breakout-v5', './Breakout', normal_m3_policy_kwargs)
