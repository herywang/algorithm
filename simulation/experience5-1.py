...
model_name = 'normal-net5-cifar10'
...
def __init_dataloader() -> None:
    ...
    train_dataloader = DataLoader(train_dataset, BATCH_SIZE, num_workers=16, pin_memory=True, shuffle=True)
    test_dataloader = DataLoader(test_dataset, BATCH_SIZE, num_workers=16, pin_memory=True)
...
if __name__ == "__main__":
    ...
    train(net, lossFunction1, optimizer2, epoches)
